...
validation: 
    - cross-source
codelists: 
    - kuan_pri_multindep_eN6gobmprWkohDigCp3Bpz_Read2.csv
    - kuan_pri_multindep_eN6gobmprWkohDigCp3Bpz_ICD10.csv
...
---
### Primary care 
{% include csv.html csvdata=site.data.codelists.kuan_pri_multindep_eN6gobmprWkohDigCp3Bpz_Read2 %}
### Secondary care 
#### Diagnoses 
{% include csv.html csvdata=site.data.codelists.kuan_pri_multindep_eN6gobmprWkohDigCp3Bpz_ICD10 %}
### Implementation 
