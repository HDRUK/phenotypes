...
validation: 
    - cross-source
codelists: 
    - kuan_HBW_LWhG3dXxEAEiBmP9PpEipV_Read2.csv
    - kuan_HBW_LWhG3dXxEAEiBmP9PpEipV_ICD10.csv
...
---
### Primary care 
{% include csv.html csvdata=site.data.codelists.kuan_HBW_LWhG3dXxEAEiBmP9PpEipV_Read2 %}
### Secondary care 
#### Diagnoses 
{% include csv.html csvdata=site.data.codelists.kuan_HBW_LWhG3dXxEAEiBmP9PpEipV_ICD10 %}
### Implementation 
