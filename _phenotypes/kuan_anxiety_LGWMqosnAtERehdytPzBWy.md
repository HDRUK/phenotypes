...
validation: 
    - cross-source
codelists: 
    - kuan_anxiety_LGWMqosnAtERehdytPzBWy_Read2.csv
    - kuan_anxiety_LGWMqosnAtERehdytPzBWy_ICD10.csv
...
---
### Primary care 
{% include csv.html csvdata=site.data.codelists.kuan_anxiety_LGWMqosnAtERehdytPzBWy_Read2 %}
### Secondary care 
#### Diagnoses 
{% include csv.html csvdata=site.data.codelists.kuan_anxiety_LGWMqosnAtERehdytPzBWy_ICD10 %}
### Implementation 
